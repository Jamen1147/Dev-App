...
var res_1 = __importDefault(require('./middlewares/res'));
...
var run = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          port = process.env.PORT || config_1.default.server.port;
        ...
        case 1:
          ...
          // Custom middlewares
          app.use(res_1.default);
          // Docs
          app.use.apply(
            app,
            __spreadArrays(['/api/v1/docs'], swagger_1.default)
          );
          // Routers
          ...
          app.use(function (req, res, next) {
            next(new error_1.NotFound('Route Not Found'));
          });
